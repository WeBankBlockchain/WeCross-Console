...
contract WeCrossHub {
    ...
    function handleRequest(
        ...
        string memory _callbackPath,
        string memory _callbackMethod
    ) private returns (string memory uid) {
    ...
    function getInterchainRequests(uint256 _num)
        public
        view
    ...
    function selectCallbackResult(string memory _uid)
        public
        view
        returns (string[] memory)
    {
    ...
    function serializeStringArray(string[] memory _arr)
        internal
        pure
    ...
    function jsonEscape(string memory _str)
        internal
        pure
        returns (string memory)
    {
