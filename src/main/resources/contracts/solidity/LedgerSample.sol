...
contract SuspenderRole {
    ...
    modifier onlySuspender() {
        require(
            isSuspender(msg.sender),
            "SuspenderRole: caller does not have the Suspender role"
        );
        _;
    }
...
contract LedgerSample is IssuerRole, Suspendable {
    ...
    /**
     * @dev Approve the passed address to spend the specified amount of assets on behalf of tx.origin.
     */
    ...
    function batchSend(
        ...
        require(
            ...
            "to and values array lenght must match."
        );
    ...
    function _checkOnLedgerSampleReceived(
        address from,
        address to,
        uint256 value,
        bytes memory data
        ...
        bytes4 retval = ILedgerSampleReceiver(to).onLedgerSampleReceived(
            from,
            to,
            value,
            data
    ...
    function _issue(
        ...
        require(
            account != address(0),
            "LedgerSample: issue to the zero address"
        );
    ...
    function _destroy(
        ...
        require(
            account != address(0),
            "LedgerSample: destroy from the zero address"
        );
    ...
    function _approve(
        ...
        require(
            owner != address(0),
            "LedgerSample: approve from the zero address"
        );
        require(
            spender != address(0),
            "LedgerSample: approve to the zero address"
        );
